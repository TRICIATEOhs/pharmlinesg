...
import jointHealthJson from "../../../data/products/supplements/jointHealth.json";
...
function JointHealth () {
    ...
    const header = "Joint health";
    const category = "Supplements / " + header;

    const productList = jointHealthJson && jointHealthJson.map((product) =>(
